...
import 'package:kids_learning/Grid%20Screen/Flower/flower_screen.dart';
...
class _FlowerListScreenState extends State<FlowerListScreen> {
                      ...
                      child: Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return listGrid(viewModel.flowerList[index], index);
                          },
                        ),
                      ),
                    ),
  ...
  Widget listGrid(FlowerModel model, int index) {
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => FlowerScreen(index)));
      },
      child: Container(
        ...
        child: Padding(
            ...
            child: Image.asset(model.flowerImage.toString(),
