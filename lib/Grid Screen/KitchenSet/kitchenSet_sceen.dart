...
class KichenSetScreen extends StatefulWidget {
  int selectedIndex;
   KichenSetScreen(this.selectedIndex,{super.key});

  @override
  State<KichenSetScreen> createState() => _KichenSetScreenState();
}

class _KichenSetScreenState extends State<KichenSetScreen> {
  ...
  void initState() {
    ...
    flutterTts.speak(viewModel.kitchenList[widget.selectedIndex].setName!);
    super.initState();
  }
  ...
  Future speak() async {
    ...
    await flutterTts.speak(viewModel.kitchenList[count].setName!);
  }
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(
                      "${viewModel.kitchenList[widget.selectedIndex].setName}",
                    ...
                    SizedBox(
                      height: 220,
                      child: Image.asset(
                          viewModel.kitchenList[widget.selectedIndex].setImage
                              .toString(),
                          width: 220),
                    ),
