...
class VegetableScreen extends StatefulWidget {
  int selectedIndex;
   VegetableScreen(this.selectedIndex,{super.key});
...
class _VegetableScreenState extends State<VegetableScreen> {
  ...
  void initState() {
    addIndex = widget.selectedIndex;
     flutterTts.speak(viewModel.vegetableList[widget.selectedIndex].vegetableName!);
    super.initState();
  }
  ...
  Future speak() async {
    ...
    await flutterTts.speak(viewModel.vegetableList[count].vegetableName!);
  }
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(
                      "${viewModel.vegetableList[widget.selectedIndex].vegetableName}",
                   ...
                   SizedBox(
                      height: 220,
                      child: Image.asset(
                          viewModel.vegetableList[widget.selectedIndex].vegetableImage
                              .toString(),
                          width: 220),
                    ),
