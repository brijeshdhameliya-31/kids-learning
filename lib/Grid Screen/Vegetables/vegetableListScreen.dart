...
import 'package:kids_learning/Grid%20Screen/Vegetables/vegetableVM.dart';
import 'package:kids_learning/Grid%20Screen/Vegetables/vegetable_screen.dart';
...
class _VegetableListScreenState extends State<VegetableListScreen> {
  VegetableVM viewModel = VegetableVM();

   @override
  void initState() {
    viewModel.vegetableList.sort((a, b) => a.vegetableName!.compareTo(b.vegetableName!));
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<VegetableVM>(
                      ...
                      child: Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return listGrid(viewModel.vegetableList[index], index);
                          },
                        ),
                      ),
                    ),
  ...
  Widget listGrid(VegetableModel model, int index) {
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => VegetableScreen(index)));
      },
      child: Container(
        ...
        child: Padding(
            ...
            child: Image.asset(model.vegetableImage.toString(),
