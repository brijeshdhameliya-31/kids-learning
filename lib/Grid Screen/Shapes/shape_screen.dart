...
class _ShapeScreenState extends State<ShapeScreen> {
  ...
  void initState() {
    ...
    flutterTts.speak(viewModel.allShapeList[widget.selectedIndex].shapeName!);
    super.initState();
  }
  ...
  Future speak() async {
    ...
    await flutterTts.speak(viewModel.allShapeList[count].shapeName!);
  }
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(
                      "${viewModel.allShapeList[widget.selectedIndex].shapeName}",
                    ...
                    SizedBox(
                      ...
                      child: Image.asset(
                          viewModel
                              .allShapeList[widget.selectedIndex].shapeImage
                              .toString(),
                          width: 220),
                    ),
