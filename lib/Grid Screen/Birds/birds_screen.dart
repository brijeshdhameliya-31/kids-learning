...
class _BirdsScreenState extends State<BirdsScreen> {
  ...
  void initState() {
    ...
    flutterTts.speak(viewModel.birdsList[widget.selectedIndex].birdsName!);
    super.initState();
  }
  ...
  Future speak() async {
    ...
    await flutterTts.speak(viewModel.birdsList[count].birdsName!);
  }
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(
                      "${viewModel.birdsList[widget.selectedIndex].birdsName}",
                    ...
                    SizedBox(
                      height: 220,
                      child: Image.asset(
                          viewModel.birdsList[widget.selectedIndex].birdsImage
                              .toString(),
                          width: 220),
                    ),
