...
import 'package:kids_learning/Grid%20Screen/Birds/birds_screen.dart';
...
class _BirdsListScreenState extends State<BirdsListScreen>
  ...
  Widget listGrid(BirdsModel model, int index) {
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => BirdsScreen(index)));
      },
      child: Container(
        ...
        child: Padding(
            ...
            child: Image.asset(model.birdsImage.toString(),
